...
<body>
    ...
    <section class="pages">
        <div class="container">
            <span class="section-tag">Экспертная поддержка на всех этапах</span>
            <h1>Контактная информация</h1>

            <p class="lead-text">
                Воплотите мечты в реальность вместе с командой <strong><?= $domainTitle ?></strong>. 
                Мы создаем технологии, которые работают на вас, и всегда готовы обсудить решения, меняющие правила игры. 
                Наши специалисты в Париже на связи по будням с 09:00 до 18:00.
            </p>
            ...
            <div class="contact-cards">
                <div class="contact-card">
                    ...
                    <h2>Пишите нам</h2>
                    <p>Для запроса доступа, деталей по AI-инструментам и предложений:</p>
                ...
                <div class="contact-card">
                    ...
                    <h2>Звоните</h2>
                    <p>Прямая линия для быстрой адаптации и консультаций по проектам:</p>
                ...
                <div class="contact-card">
                    ...
                    <h2>Наш адрес</h2>
                    <p>Центр инноваций <strong><?= $domainTitle ?></strong> в самом сердце Европы:</p>
            ...
            <div class="contact-extra">
                <p>
                    ...
                    Чтобы получить больше информации, воспользуйтесь формой на <a href="./#contact">главной странице</a>.
                </p>
            </div>
        </div>
    </section>
